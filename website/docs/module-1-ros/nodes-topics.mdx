...
You've learned the fundamentals of ROS 2 communication! Next, we'll explore [Services and Actions](/docs/module-1-ros/services-actions) for request/response patterns.
